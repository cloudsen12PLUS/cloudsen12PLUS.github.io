...
<style lang="scss">
  ...
  a, button {
      @apply  after:content-[''] after:w-5 after:h-5 after:inline-block after:relative after:top-1 after:bg-no-repeat after:bg-right-top after:bg-[url('../cloudsen12/assets/icon-arrow-top.svg')];
  }
</style>
