        ...
        <li class="relative block">
          ...
          >
            <div class="relative z-10">
              <div class="text-base relative font-semibold pr-6 after:content-[''] after:w-5 after:h-5 after:bg-[url(/cloudsen12/assets/icon-arrow-top.svg)] after:bg-no-repeat after:bg-right-top after:right-0 after:top-0 after:absolute after:dark:invert">
